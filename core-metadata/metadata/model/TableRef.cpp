...
TblColRef * TableRef::getColumn(const std::string& name) {
	return columns.find(name)->second;
}

std::string TableRef::getAlias() {
	return alias;
}

TableDesc * TableRef::getTableDesc() {
	return table;
}

std::string TableRef::getTableName() {
