...
if(GTEST_SEARCH_PATH)
  find_path(GTEST_INCLUDE_DIR NAMES gtest/gtest.h PATHS ${GTEST_SEARCH_PATH} NO_SYSTEM_ENVIRONMENT_PATH PATH_SUFFIXES "include")
    find_library(GTEST_LIBRARY NAMES gtest PATHS ${GTEST_SEARCH_PATH} NO_SYSTEM_ENVIRONMENT_PATH PATH_SUFFIXES "lib")
    ...
    set(GTEST_SEARCH_PATH ${PROJECT_BINARY_DIR})
