...
void ORCBlockAssigner::master_setup_handler() { num_workers_alive_ = Context::get_worker_info().get_num_workers(); }
...
/// the given url
int ORCBlockAssigner::get_num_finished(std::string& url) { return finish_dict_[url]; }
