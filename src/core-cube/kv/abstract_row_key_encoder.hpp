...
class AbstractRowKeyEncoder {
   public:
    ...
    inline void set_cuboid_id(Cuboid* cuboid) { cuboid_ = cuboid; }
   ...
   protected:
    AbstractRowKeyEncoder(const std::shared_ptr<CubeDesc>& cube_desc, Cuboid* cuboid)
